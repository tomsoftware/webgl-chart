...
const time = new GpuFloatBuffer([1, 2, 3]);

// (2) create series objects
const points = new SeriesPoint(time, new GpuFloatBuffer([3.1, 4.2, 5.3])
  .setColor(Color.blue)
  .setPointSize(4);

const line = new SeriesLine(time, new GpuFloatBuffer([1.1, 2.2, 3.3])
  .setColor(Color.darkGreen)
  .setThickness(2);

const bars = new SeriesBar(time, new GpuFloatBuffer([4, 3, 2])
  .setColor(Color.red)
  .setBarWidth(0.02);
